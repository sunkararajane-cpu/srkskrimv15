...
import { PersonalDetailsSettingsSheet } from '../components/PersonalDetailsSettingsSheet';
...
export default function IdentityScreen() {
  ...
  const [showPersonalDetailsSettings, setShowPersonalDetailsSettings] = useState(false);
  ...
  return (
    <div className="w-full h-full overflow-y-auto no-scrollbar bg-skrim-bg relative pb-20">
             ...
             >
               ...
               <div className="p-4 flex flex-col gap-2 overflow-y-auto pb-8">
                 <button className="flex items-center gap-4 p-4 hover:bg-white/5 rounded-2xl transition" onClick={() => {
                   ...
                   setShowPersonalDetailsSettings(true);
                 }}>
                   ...
                   <div className="flex-1 text-left">
                     <p className="font-bold text-white text-lg">Personal Details</p>
                     <p className="text-white/50 text-sm">Name, username, email, date of birth, location</p>
                   </div>
                 </button>
      ...
      {/* Personal Details Settings Sheet */}
      <PersonalDetailsSettingsSheet
        isOpen={showPersonalDetailsSettings}
        onClose={() => setShowPersonalDetailsSettings(false)}
        onBack={() => { setShowPersonalDetailsSettings(false); setShowSettingsMenu(true); }}
      />
